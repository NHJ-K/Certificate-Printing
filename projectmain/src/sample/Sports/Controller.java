...
public class Controller {
    ...
    public void actionit(ActionEvent actionEvent) throws IOException, JRException, DocumentException, SQLException, ClassNotFoundException {
        ...
        PreparedStatement pst = con.prepareStatement("select * from sport_student");
...
// columnWidths = {column1, column2, column3...}
    ...
    public void adder1(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        ...
        if (reg.getText().trim().isEmpty() || name.getText().trim().isEmpty() || depaet.getText().trim().isEmpty() || (cbevrnt1.getValue() == "null" && cbevrnt2.getValue() == "null" && cbevrnt3.getValue() == "null")) {
            ...
            String sql1 = "select * from sport_student where name='" + s2 + "' and deparment='" + s3 + "'";
            String sql2 = "select * from sport_student where rehno=" + s1;
            Connection con = consql.getcon();
            ...
            if (falgs == 1) {
                ...
                try {
                    String sqlQ2 = "insert into sport_student(rehno,name,deparment,event1,event2,event3) VALUES(" + s1 + ",'" + s2 + "','" + s3 + "','" + s4 + "','" + s5 + "','" + s6 + "')";
    ...
    public void wordcome(KeyEvent keyEvent) {
        ...
        try {
            sqlconnection consql = new sqlconnection();
            Connection con = consql.getcon();
            PreparedStatement pst = con.prepareStatement("select * from sport_student Where " + s + " like '" + searcherfeld.getText() + "%'");
            ResultSet rs = pst.executeQuery();
            while (rs.next()) {
                oblist.add(new ModelTable(rs.getString(1), rs.getString("rehno"),
                        rs.getString("Name"), rs.getString("deparment"),
    ...
    public void onediter(ActionEvent actionEvent) {
        ...
        if (regno.getText().trim().isEmpty() || nme.getText().trim().isEmpty() || depar.getText().trim().isEmpty() || (ev1.getValue() == "null" && ev2.getValue() == "null" && ev3.getValue() == "null")) {
            ...
            try {
                String sqlQ2 = "UPDATE sport_student SET rehno=" + s1 + ", name='" + s2 + "', deparment='" + s3 + "', event1='" + s4 + "', event2='" + s5 + "', event3='" + s6 + "' WHERE Chestno= " + che;
                sqlconnection consql = new sqlconnection();
                Connection con = consql.getcon();
    ...
    public void ondelecte1(ActionEvent actionEvent) {
        try {
            String sqlQ2 = "DELETE FROM sport_student WHERE Chestno=" + che;
            sqlconnection consql = new sqlconnection();
            Connection con = consql.getcon();
            PreparedStatement ps2 = con.prepareStatement(sqlQ2);
            ps2.executeUpdate();
    ...
    public void foraddwinner(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        String sqlQ1 = "select * from sport_student where Chestno=" + win1st.getText();
        String sqlQ2 = "select * from sport_student where Chestno=" + win2st.getText();
        String sqlQ3 = "select * from sport_student where Chestno=" + win3st.getText();
        String sqlu1 = null, sqlu2 = null, sqlu3 = null;
        String event = (String) winevent.getValue();
        String chesql1 = "select * from sport_winner where Chestno=" + win1st.getText() + " and Event='" + event + "'";
        String chesql2 = "select * from sport_winner where Chestno=" + win2st.getText() + " and Event='" + event + "'";
        String chesql3 = "select * from sport_winner where Chestno=" + win3st.getText() + " and Event='" + event + "'";
        ...
        if (chestflage1 == 1 && chestflage2 == 1 && chestflage3 == 1) {
            ...
            try {
                ...
                while (rs1.next() && rs2.next() && rs3.next()) {
                    sqlu1 = "insert into sport_winner VALUES(" + win1st.getText() + ",'" + rs1.getString(3) + "','" + rs1.getString(4) + "','" + event + "',1)";
                    sqlu2 = "insert into sport_winner VALUES(" + win2st.getText() + ",'" + rs2.getString(3) + "','" + rs2.getString(4) + "','" + event + "',2)";
                    sqlu3 = "insert into sport_winner VALUES(" + win3st.getText() + ",'" + rs3.getString(3) + "','" + rs3.getString(4) + "','" + event + "',3)";
                    s11 = rs1.getString(5);
                    s12 = rs1.getString(6);
                    s13 = rs1.getString(7);
                    s21 = rs2.getString(5);
    ...
    public void tload2() {
        ...
        try {
            sqlconnection consql = new sqlconnection();
            Connection con = consql.getcon();
            PreparedStatement pst = con.prepareStatement("select * from sport_winner");
            ResultSet rs = pst.executeQuery();
            while (rs.next()) {
    ...
    public void searchkeyon(KeyEvent keyEvent) {
        ...
        try {
            sqlconnection consql = new sqlconnection();
            Connection con = consql.getcon();
            PreparedStatement pst = con.prepareStatement("select * from sport_winner Where " + s + " like '" + sercher2.getText() + "%'");
            ResultSet rs = pst.executeQuery();
            while (rs.next()) {
                oblist.add(new ModelTabelW(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5)));
            }
...
// columnWidths = {column1, column2, column3...}
    ...
    public void edieteraction2(ActionEvent actionEvent) {
        ...
        if (chesttext.getText().trim().isEmpty() || nametext.getText().trim().isEmpty() || departtex.getText().trim().isEmpty() || eventtext.getValue() == "null" && ranktext.getText() == "null") {
            ...
            try {
                String sqlQ2 = "UPDATE sport_winner SET Chestno=" + s1 + ", Name='" + s2 + "', Department='" + s3 + "', Event='" + s4 + "', Rank=" + s5 + " WHERE Chestno= " + che + " and Event='" + ev + "'";
                sqlconnection consql = new sqlconnection();
                Connection con = consql.getcon();
                PreparedStatement ps2 = con.prepareStatement(sqlQ2);
                ps2.executeUpdate();
    ...
    public void deleteracction2(ActionEvent actionEvent) {
        try {
            String sqlQ2 = "DELETE FROM sport_winner WHERE Chestno= " + che + " and Event='" + ev + "'";
            sqlconnection consql = new sqlconnection();
            Connection con = consql.getcon();
            PreparedStatement ps2 = con.prepareStatement(sqlQ2);
            ps2.executeUpdate();
    ...
    public void readingsport_event(MouseEvent mouseEvent) {
        ObservableList list = FXCollections.observableArrayList();
        try {
            sqlconnection consql = new sqlconnection();
            Connection con = consql.getcon();
    ...
    public void dubleclickrowpass(MouseEvent mouseEvent) throws SQLException, ClassNotFoundException {
        if (mouseEvent.getClickCount() == 2) {
            ...
            sqlconnection consql = new sqlconnection();
            Connection con2 = consql.getcon();
            PreparedStatement pst2 =con2.prepareStatement("select * from sport_printing where Name='"+ adder.getName()+"' and Event='"+adder.getEvent()+"'");
            ...
            if(i<1) {
                ...
                Connection con = consql.getcon();
                PreparedStatement pst = con.prepareStatement("insert into sport_printing VALUES(" + adder.getChest() + ",'" + adder.getName() + "','" + adder.getDepart() + "','" + adder.getEvent() + "'," + adder.getRank() + ") ");
                pst.executeUpdate();
                tloder4();
            }
            else
    ...
    public void actionforpassingtable(MouseEvent mouseEvent) {
        ...
        try {
            sqlconnection consql = new sqlconnection();
            Connection con = consql.getcon();
            PreparedStatement pst = con.prepareStatement("INSERT INTO sport_printing SELECT * FROM sport_winner");
            pst.executeUpdate();
            tloder4();
        } catch (SQLException | ClassNotFoundException throwables) {
            throwables.printStackTrace();
    ...
    public void deletekeypress(KeyEvent keyEvent) throws SQLException, ClassNotFoundException {
        if (keyEvent.getCode() == KeyCode.DELETE) {
            ...
            PreparedStatement pst = con.prepareStatement("DELETE FROM sport_printing WHERE Chestno= " + q.getChest()+ " and Event='" + q.getEvent() + "'");
            pst.executeUpdate();
        }
    }
    ...
    public void actionforprintercer(ActionEvent actionEvent) throws IOException {
        ...
        try {
            ...
            sqlconnection consql = new sqlconnection();
            Connection con = consql.getcon();
            PreparedStatement pst = con.prepareStatement("select * from sport_printing");
            ResultSet rs = pst.executeQuery();
            while (rs.next()) {
    ...
    public  void resettloder() throws SQLException, ClassNotFoundException {
        sqlconnection consql = new sqlconnection();
        Connection con = consql.getcon();
        PreparedStatement pst = con.prepareStatement("DELETE FROM sport_printing");
        pst.executeUpdate();
    ...
    public void readingarts_event(MouseEvent mouseEvent) {
        ObservableList list = FXCollections.observableArrayList();
        try {
            sample.Arts.sqlconnection consql = new sample.Arts.sqlconnection();
            Connection con = consql.getcon();
            Statement stmt = con.createStatement();
